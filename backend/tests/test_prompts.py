...
class TestCreatePrompt:
    ...
    async def test_image_mode_update_with_history(self) -> None:
        ...
        with (
            patch("prompts.SYSTEM_PROMPTS", mock_system_prompts),
    ...
    async def test_text_mode_create_generation(self) -> None:
        ...
        with patch("prompts.TEXT_SYSTEM_PROMPTS", mock_text_system_prompts):
            ...
            expected: ExpectedResult = {
                "messages": [
                    {"role": "system", "content": "Mock Text System Prompt"},
                    {"role": "user", "content": f"Generate UI for {text_description}"},
                ],
                "image_cache": {},
            }
    ...
    async def test_text_mode_update_with_history(self) -> None:
        ...
        with (
            patch("prompts.TEXT_SYSTEM_PROMPTS", mock_text_system_prompts),
            ...
            expected: ExpectedResult = {
                "messages": [
                    {"role": "system", "content": "Mock Text System Prompt"},
                    {"role": "user", "content": f"Generate UI for {text_description}"},
                    {"role": "assistant", "content": "<html>Initial dashboard</html>"},
    ...
    async def test_video_mode_basic_prompt_creation(self) -> None:
        ...
        params: Dict[str, Any] = {
            "prompt": {"text": "", "images": [video_data_url]},
            "generationType": "create",
        }
        ...
        expected: ExpectedResult = {"messages": [], "image_cache": {}}
